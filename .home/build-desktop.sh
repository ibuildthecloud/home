...
echo 'deb http://us.archive.ubuntu.com/ubuntu jammy main universe restricted' > /etc/apt/sources.list
echo 'deb http://us.archive.ubuntu.com/ubuntu jammy-updates main universe restricted' >> /etc/apt/sources.list
echo 'deb http://us.archive.ubuntu.com/ubuntu jammy-security main universe restricted' >> /etc/apt/sources.list
echo 'deb http://us.archive.ubuntu.com/ubuntu jammy-backports main universe restricted' >> /etc/apt/sources.list
...
echo 'deb [arch=amd64] https://download.virtualbox.org/virtualbox/debian jammy contrib' >> /etc/apt/sources.list
...
curl -fsSL https://packages.microsoft.com/repos/ms-teams/dists/stable/Release.gpg | apt-key add -
...
[ -e teams.deb ] || curl -fL -o teams.deb 'https://packages.microsoft.com/repos/ms-teams/pool/main/t/teams/teams_1.5.00.10453_amd64.deb'
