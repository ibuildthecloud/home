...
[ -e slack-desktop.deb ] || curl -fL -o slack-desktop.deb https://downloads.slack-edge.com/linux_releases/slack-desktop-4.16.0-amd64.deb
...
[ -e teams.deb ] || curl -fL -o teams.deb 'https://packages.microsoft.com/repos/ms-teams/pool/main/t/teams/teams_1.4.00.7556_amd64.deb'
